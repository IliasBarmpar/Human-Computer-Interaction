...
<html lang="en">
  ...
  <body>
    ...
    <form class="form1" action="action_page.php" method="post">
     <div class="form1">
       <h1>Εγγραφή Χρήστη για Βιβλιοπώλες</h1>
       ...
       <input type="text" placeholder="Εισαγωγή Επωνυμίας Καταστήματος" name="shopname" maxlength="30" required>

       <h3><b>Διεύθυνση Καταστήματος</b></h3>
       <input type="text" placeholder="Εισαγωγή Διεύθυνσης Καταστήματος" name="adress" maxlength="30" required>

       <h3><b></b>Ωράριο Καταστήματος</h3>
       <input type="text" placeholder="Εισαγωγή Ωραρίου Καταστήματος" name="lastname" maxlength="30" required>
